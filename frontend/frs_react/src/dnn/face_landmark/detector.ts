...
import { MEDIAPIPE_FACE_MESH_KEYPOINTS } from './shared_constants';
import { FaceLandmarksDetector } from './face_landmarks_detector';
import { calculateAssociationNormRect } from '../shared/association_norm_rect';
import { calculateLandmarkProjection } from '../shared/calculate_landmark_projection';
import { convertImageToTensor } from '../shared/convert_image_to_tensor';
import { calculateDetectionsToRects } from '../shared/detection_to_rect';
import { getImageSize, toImageTensor } from '../shared/image_utils';
import { ImageSize, Keypoint } from '../shared/interfaces/common';
import { Rect } from '../shared/interfaces/shapes';
import { Detection } from '../shared/interfaces/shapes';
import { landmarksRefinement } from '../shared/landmarks_refinement';
import { landmarksToDetection } from '../shared/landmarks_to_detection';
import { normalizedKeypointsToKeypoints } from '../shared/normalized_keypoints_to_keypoints';
import { tensorsToLandmarks } from '../shared/tensors_to_landmarks';
import { transformNormalizedRect } from '../shared/transform_rect';
...
export async function load():
    ...
    return new MediaPipeFaceMeshTfjsLandmarksDetector(
        detector as MediaPipeFaceDetectorTfjs, landmarkModel, 100,

...
const LEFT_EYE_CONNECTIONS: PairArray = [
    [263, 249],
    [249, 390],
    [390, 373],
    [373, 374],
...
const LEFT_EYEBROW_CONNECTIONS: PairArray = [
    [276, 283],
    [283, 282],
    [282, 295],
    [295, 285],
...
const RIGHT_EYE_CONNECTIONS: PairArray = [
    [33, 7],
    [7, 163],
    [163, 144],
    [144, 145],
...
const RIGHT_EYEBROW_CONNECTIONS: PairArray = [
    [46, 53],
    [53, 52],
    [52, 65],
    [65, 55],
...
const indexLabelPairs: Array<[number, string]> =
    Object.entries(MEDIAPIPE_FACE_MESH_KEYPOINTS_BY_CONTOUR)
        .map(
            ([label, indices]) =>

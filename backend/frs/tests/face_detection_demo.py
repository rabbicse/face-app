...
face_detect = RetinaFaceDetector(model_path='../models/mobilenet0.25_Final.pth',
                                 # mobilenet_model_tar=os.path.abspath("../models/mobilenetV1X0.25_pretrain.tar"),
                                 network='mobile0.25')
for i in range(1):
